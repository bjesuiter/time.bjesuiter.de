/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv` (hash: d085a6e1fed060e7a126c85d0e2fe39c)
...
declare namespace Cloudflare {
	interface Env {
		...
		CLOCKIFY_TEST_API_KEY: string;
		CLOCKIFY_TEST_WORKSPACE_ID: string;
		CLOCKIFY_TEST_CLIENT_ID: string;
		CLOCKIFY_TEST_PROJECT_IDS: string;
		DB: D1Database;
	}
}
