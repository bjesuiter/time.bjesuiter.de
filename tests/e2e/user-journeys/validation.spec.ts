...
test.describe("Form Validation and Error Handling", () => {
  test("validates signup required fields", async ({ page, serverUrl }) => {
    ...
    const signupDisabled = page.locator('text=User registration is currently disabled');
  ...
  test("validates signup password confirmation", async ({ page, serverUrl }) => {
    await page.goto(`${serverUrl}/signup`);
    await page.waitForLoadState("networkidle");
  ...
  test("shows error for invalid signin credentials", async ({ page, serverUrl }) => {
    await page.goto(`${serverUrl}/signin`);
    await page.waitForLoadState("networkidle");
  ...
  test("forms have proper labels and ARIA attributes", async ({ page, serverUrl }) => {
    // Test signup form
    await page.goto(`${serverUrl}/signup`);
    await page.waitForLoadState("networkidle");
    ...
    await expect(page.locator('input[name="confirmPassword"][type="password"]')).toBeVisible();
